...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  tools:
    "Download the latest tools and utility apps for mobile gaming in Pakistan. Game injectors, boosters, and optimization tools — all scanned for malware and verified safe.",
  general:
...
export default async function CategoryPage({
  ...
  const sortBy = (sort === "top-rated" || sort === "most-viewed" ? sort : "newest") as
    | "newest"
    | "top-rated"
    | "most-viewed";
